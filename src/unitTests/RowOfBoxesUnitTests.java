...
public class RowOfBoxesUnitTests
{
	...
	{
		String response = ConsoleTester.getOutput("7\r\n10\r\n0\r\n");
	...
	{
		String response = ConsoleTester.getOutput("0\r\n");
		verify.that(response).matches("\\w+\\?(\\s|\\r|\\n)+All done!");
	}
	...
	{
		String response = ConsoleTester.getOutput("3\r\n5\r\n0\r\n");
	...
	{
		String response = ConsoleTester.getOutput("1\r\n8\r\n0\r\n");
	...
	{
		String response = ConsoleTester.getOutput("4\r\n0\r\n0\r\n");
